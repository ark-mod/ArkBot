...
namespace ArkBot.Modules.Application.Services
{
    public class SavegameBackupService : ISavegameBackupService
    {
        ...
        public List<BackupListEntity> GetBackupsList(string[] keys = null, Func<FileInfo, BackupListEntity, bool> filterFunc = null)
        {
            ...
            if (_config.Backups?.Enabled != true || string.IsNullOrWhiteSpace(_config.Backups?.BackupsDirectoryPath) || !Directory.Exists(_config.Backups.BackupsDirectoryPath)) return result;
