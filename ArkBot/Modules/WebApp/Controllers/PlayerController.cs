...
namespace ArkBot.Modules.WebApp.Controllers
{
    public class PlayerController : BaseApiController
    {
            ...
            bool incTribeLog)
        {
            ...
            if (incGenerators) vm.Generators = BuildGeneratorViewModelsForPlayerId(context, playerId);
            ...
            bool incTribeLog)
        {
            ...
            if (incGenerators) vm.Generators = BuildGeneratorViewModelsForPlayerId(context, player.Id);
            ...
            if (context.TamedCreatures != null)
            {
                    ...
                    .Concat(tribecreatures_cryo.Select(x => new { c = x, o = "tribe", cryo = true })))
                {
                    ...
                    var vmc = new TamedCreatureViewModel
                    {
                        ...
                        {
                            Female = new CreatureIdViewModel { Id1 = item.c.DinoAncestors.First().FemaleId1, Id2 = item.c.DinoAncestors.First().FemaleId2 },
                            Male = new CreatureIdViewModel { Id1 = item.c.DinoAncestorsMale.First().MaleId1, Id2 = item.c.DinoAncestorsMale.First().MaleId2 }
                        } : null,
