...
@Component({
  selector: 'arkmap-structures2',
  templateUrl: './arkmap-structures2.component.html',
  styleUrls: ['./arkmap-structures2.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class ArkmapStructures2Component implements OnInit, OnDestroy, OnChanges {
